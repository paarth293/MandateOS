...
export default async function AttackPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
        ...
        {firstMandate && (
          <div className="text-xs text-slate-500">
            Live target:{" "}
            <span className="font-semibold text-slate-700">{firstMandate.agentName}</span>
          </div>
        )}
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-6 text-xs text-slate-600">
        <h2 className="text-sm font-semibold text-slate-800 mb-3">Defense layers under test</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <div className="rounded bg-white p-3 border border-slate-200">
            <span className="font-semibold text-slate-900">Signature verification</span>
          ...
          <div className="rounded bg-white p-3 border border-slate-200">
            <span className="font-semibold text-slate-900">Replay shield</span>
            <p className="mt-0.5 text-slate-500">
          ...
          <div className="rounded bg-white p-3 border border-slate-200">
            <span className="font-semibold text-slate-900">Spending caps</span>
            <p className="mt-0.5 text-slate-500">
          ...
          <div className="rounded bg-white p-3 border border-slate-200">
            <span className="font-semibold text-slate-900">Category whitelist</span>
            <p className="mt-0.5 text-slate-500">
          ...
          <div className="rounded bg-white p-3 border border-slate-200">
            <span className="font-semibold text-slate-900">Timestamp drift</span>
            <p className="mt-0.5 text-slate-500">
